...
class Wallet:
    ...
    def generate_keys(self):
        ...
        return (
            binascii.hexlify(private_key.exportKey(format='DER'))
            .decode('ascii'),
    ...
    def sign_transaction(self, sender, recipient, amount):
        ...
        payload = SHA256.new((f'{sender}{recipient}{amount}').encode('utf8'))
    ...
    def verify_transaction(transaction):
        ...
        payload = SHA256.new((f'{transaction.sender}{transaction.recipient}{transaction.amount}').encode('utf8'))
